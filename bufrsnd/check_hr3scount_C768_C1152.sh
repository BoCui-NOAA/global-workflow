...
COM1=/lfs/h2/emc/ptmp/$LOGNAME/com_hr3scoutC768/gfs/prod/gfs.$da00/$hr00/products/atmos/gempak
COM2=/lfs/h2/emc/ptmp/$LOGNAME/com_hr3scoutC1152/gfs/prod/gfs.$da00/$hr00/products/atmos/gempak
    ...
    for fhr in $times; do
        ...
        for stnm in $stations; do
    		...
    		snprof <<- EOF
				...
				MARKER   = 0
				BORDER   = 1//2
				TITLE    = 4// "Fcst hr:$fhr; hr3C768-BLUE;            "
...
dir_new=sample.$da00${hr00}_hr3scout_C768_C1152
